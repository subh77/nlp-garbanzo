...
#Load data
train  = pd.read_csv('C:/Users/pream1/Downloads/practice_twitter/data/train_E6oV3lV.csv')
test = pd.read_csv('C:/Users/pream1/Downloads/practice_twitter/data/test_tweets_anuFYb8.csv')
train.head()
...
submission.to_csv('C:/Users/pream1/Downloads/practice_twitter/sub_lreg_bow.csv', index=False) # writing data to a CSV file
